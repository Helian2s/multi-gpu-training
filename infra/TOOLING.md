...
6. Fix S3 stage-out permission for EXP-02/07/08/09 by approving either
   additional experiment prefixes or a shared permitted artifact prefix.
7. Record the EXP-01 and A2-prep ECR scan finding review dispositions before
   treating either image as accepted beyond qualification.
