...
5. Verify ECR image pull through `FinetuningGpuInstanceRole` during AWS host
   qualification.
6. Review the EXP-01 ECR scan findings after scan-on-push completes.
